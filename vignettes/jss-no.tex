...
<aumc_env[7]>
      ...
      [23,106 x 19]    [4,907,269 x 31]      [651,248 x 11] 
...
\toprule
  & MIMIC-III & eICU & AmsterdamUMCdb & HiRID & MIMIC-IV\\
\midrule
Number of tables & 26 & 31 & 7 & 5 & 27\\
Disk storage [GB] & 7.58 & 6.49 & 13.65 & 4.52 & 10.33\\
Largest table [rows] & 330,712,483 & 151,604,232 & 977,625,612 & 776,921,131 & 329,499,788\\
Available concepts\textsuperscript{*} & 89 & 86 & 86 & 75 & 88\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Data collection}}\\
\hspace{1em}Time span & 2001--2012 & 2014--2015 & 2003--2016 & 2008--2016 & 2008--2019\\
\hspace{1em}Country of origin & United States & United States & Netherlands & Switzerland & United States\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Admission counts}}\\
\hspace{1em}ICU & 61,532 & 200,859 & 23,106 & 33,904 & 76,540\\
\hspace{1em}Hospital & 57,841 & 166,355 & - & - & 69,300\\
\hspace{1em}Unique patients & 46,476 & - & 20,109 & - & 53,150\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Stay lengths [day]}}\\
\hspace{1em}ICU stays & 2.09 (1.11--4.48) & 1.57 (0.82--2.97) & 1.07 (0.84--3.67) & 0.99 (0.81--2.16) & 1.93 (1.09--3.73)\\
\hspace{1em}Hospital stays & 6.57 (3.80--11.86) & 5.05 (2.71--9.03) & - & - & 6.62 (3.87--11.36)\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Vital signs [1/hour]}}\\
\hspace{1em}Heart rate & 1.00 (1.00--1.02) & 12.00 (12.00--12.00) & 60.00 (60.00--60.00) & 30.00 (30.00--60.00) & 1.00 (1.00--1.00)\\
\hspace{1em}Mean arterial pressure & 1.00 (1.00--1.33) & 12.00 (4.00--12.00) & 60.00 (60.00--60.00) & 30.00 (30.00--60.00) & 1.00 (1.00--1.02)\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Lab tests [1/day]}}\\
\hspace{1em}Bilirubin & 1.00 (0.86--1.38) & 1.00 (0.91--1.20) & 1.00 (0.33--1.06) & 1.00 (0.98--1.04) & 1.00 (0.94--1.30)\\
\hspace{1em}Lactate & 4.72 (1.84--10.75) & 3.78 (1.54--6.67) & 7.42 (4.30--14.12) & 4.66 (2.96--7.96) & 4.68 (2.29--9.47)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
# Index var:  `charttime` (1 hours)
        ...
        <chr>           <int> <drtn>    <dbl>
      1 eicu_demo      141764 NA          119
      2 eicu_demo      141764 ~1h         105
      3 eicu_demo      141764 ~2h          95
      4 eicu_demo      141764 ~3h         106
      5 eicu_demo      141764 ~4h         102
    ...
152,193 mimic_demo     298685 ~13d         60
152,194 mimic_demo     298685 ~13d         56
152,195 mimic_demo     298685 ~13d         50
152,196 mimic_demo     298685 ~13d         48
152,197 mimic_demo     298685 ~13d          0
...
# Index var:  `charttime` (15 mins)
    ...
    2     201006 ~2h        NA      83
    3     201006 ~2h        NA      91
    4     201006 ~15m        2.4   175
    5     201006 ~11h       NA     129
  ...
1,961     298685 ~10d       NA     159
1,962     298685 ~11d        2.2   153
1,963     298685 ~12d       NA     182
1,964     298685 ~12d       NA     122
1,965     298685 ~12d        2.5   121
...
# Index var:  `charttime` (1 hours)
      icustay_id charttime   age   glu
           <int> <drtn>    <dbl> <dbl>
    1     201006 ~14h       68.9   116
    2     201006 ~3h        68.9    83
    3     201006 ~3h        68.9    91
    4     201006 NA         68.9   175
    5     201006 ~11h       68.9   129
  ...
1,910     298685 ~10d       80.1   159
1,911     298685 ~11d       80.1   153
1,912     298685 ~12d       80.1   182
1,913     298685 ~12d       80.1   122
1,914     298685 ~12d       80.1   121
...
# Index var:  `startdate` (1 hours)
     ...
     1     201006 ~7h       TRUE  NA           NA      ?
     2     201006 ~8h       NA    TRUE         NA      ~2d
     3     201006 ~9h       NA    TRUE          0.0460 ?
     4     201006 ~10h      NA    TRUE          0.0690 ?
     5     201006 ~11h      NA    TRUE          0.0690 ?
   ...
12,430     298685 ~25d      NA    TRUE         NA      ?
12,431     298685 ~25d      NA    TRUE         NA      ?
12,432     298685 ~25d      NA    TRUE         NA      ?
12,433     298685 ~25d      NA    TRUE         NA      ?
12,434     298685 ~25d      NA    TRUE         NA      ?
...
# Duration var: `dur_var`
   icustay_id starttime dur_var      dex
        <int> <drtn>    <drtn>     <dbl>
 1     216185 ~5d       ~1m     15000
 2     249805 ~13d      ~11h        9.09
 3     253931 ~6d       ~1m       500.
 4     277238 ~2h       ~2h       100.
 5     277238 ~3h       ~1m     15000
 6     277238 ~5h       ~1m     15000
 7     285750 ~4h       ~1m     15000
 8     286072 ~4d       ~1m      7500
 9     286072 ~4d       ~1m      7500
10     286072 ~5d       ~1m      7500
\end{CodeOutput}
\end{CodeChunk}
...
# Index var:  `charttime` (1 hours)
     ...
     1     201006 ~14h          1 NA           NA      NA        NA        1
     2     201006 ~3h           1 NA           NA      NA        NA        1
     3     201006 ~3h           1 NA           NA      NA        NA        1
     4     201006 ~14h          2 NA           NA      NA         1        1
     5     201006 NA            3 NA            0       1         1        1
   ...
14,291     298685 ~13d          2 NA            0       0         1        1
14,292     298685 ~13d          2 NA            0       0         1        1
14,293     298685 ~13d          2 NA            0       0         1        1
14,294     298685 ~13d          1 NA            0       0         0        1
14,295     298685 ~13d          1 TRUE          0       0        NA        1
...
{\centering \includegraphics{jss_files/figure-latex/src-setup-1} 
...
{\centering \includegraphics{jss_files/figure-latex/data-loading-1} 
...
# Id var:      `icustay_id`
  ...
  1     201006  198503      10076 NA               ~17h
  2     201204  114648      42321 NA               ~23h
  3     203766  126949      10045 NA               ~1h
  4     204132  157609      40310 NA               ~23h
  5     204201  177678      10104 NA               ~17h
...
132     295043  170883      10124 NA               ~18h
133     295741  176805      10090 NA               ~23h
134     296804  110244      10035 NA               ~2h
135     297782  167612      43909 NA               ~23h
136     298685  151323      42075 NA               ~23h
...
\begin{center}\includegraphics{jss_files/figure-latex/cox-plot-1} \end{center}
...
\begin{center}\includegraphics{jss_files/figure-latex/diabetes-visualize-1} \end{center}
